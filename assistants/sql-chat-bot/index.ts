...
export default {
  ...
  getPrompt: (engine?: Engine, schema?: string): string => {
    ...
    const basicPrompt = [
      ...
      "When generating SQL queries, use the table and column comments to understand the semantic meaning of the data.",
      "Prefer using columns with meaningful comments that match the user's intent.",
    ];
    ...
    if (schema) {
      ...
      finalPrompt.push("Pay attention to table and column comments as they provide semantic meaning to the data.");
    }
