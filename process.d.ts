declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    // Required if using internal Qwen API. Set to "true" to use internal Qwen service.
    QWEN_INTERNAL: string;
    // Required if using Qwen API. Your Qwen APP ID.
    QWEN_APP_ID: string;
    // Required if using Qwen API. Your Qwen Secret Key.
    QWEN_SECRET_KEY: string;
    // Optional. Qwen API endpoint. Defaults to http://25.41.34.249:8008/api/ai/qwen/72b/chat
    QWEN_API_ENDPOINT: string;
  }
}
